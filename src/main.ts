...
import { TERMINAL_SERVICE } from './app/core/services/interfaces/terminal';
import { TERMINAL_COMMAND_SERVICE } from './app/core/services/interfaces/terminal-command';
...
import { TerminalCommandService } from './app/core/services/terminal-command.service';
import { TerminalService } from './app/core/services/terminal.service';
    ...
    .then((config) => {
      ...
      bootstrapApplication(AppComponent, {
        providers: [
          ...
          {provide: TERMINAL_SERVICE, useClass: TerminalService},
          {provide: TERMINAL_COMMAND_SERVICE, useClass: TerminalCommandService},
